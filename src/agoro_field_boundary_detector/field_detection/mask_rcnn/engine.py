...
from field_detection.mask_rcnn.coco_eval import CocoEvaluator
from field_detection.mask_rcnn.coco_utils import (
...
#     warmup_lr_scheduler,
# )
from field_detection.mask_rcnn.utils import (
    MetricLogger,
    SmoothedValue,
    reduce_dict,
    warmup_lr_scheduler,
